      ...
      <section>
        ...
        <table class="syntax-table">
          <tbody>
            ...
            <tr><td>빈칸 색</td><td>배색 목록의 <b>빈칸</b> 칩 — 코가 <b>없는</b> 자리의 색 (대바늘 빈칸 / 코바늘 바탕)</td></tr>
            <tr><td>배색 목록</td><td>편집 화면 위 <b>배색</b> 버튼을 누르면 펼쳐진다 (게이지도 마찬가지)</td></tr>
            <tr><td>기본 색</td><td>배색 목록 맨 앞의 <b>기본</b> 칩 — 실 색을 지정하지 않은 코들이 쓰는 색 (기본 흰색).
              도안의 메인 컬러라서 여기서 바꾸면 본문을 고치지 않고도 전체 톤이 바뀐다</td></tr>
