      ...
      <section>
        ...
        <table class="syntax-table">
          <tbody>
            ...
            <tr><td>기본 배경색</td><td>구분선 앞의 두 칩 — <b>빈칸</b>(코가 없는 자리) · <b>칸</b>(기호가 있는 모든 칸의 배경)</td></tr>
            <tr><td>기본 기호 색</td><td>구분선 뒤 첫 칩 <b>기호</b> — 실 색을 지정하지 않은 코를 그리는 <b>잉크</b> 색 (실 색이 아니다). 옆의 숫자가 그 코 수</td></tr>
            <tr><td>색 없는 코에 실 색 주기</td><td>그 칩 옆 <b>페인트 버튼</b> — 색을 고르면 <b>본문의 색 없는 코 전부</b>에 <code>:색</code> 이 들어간다</td></tr>
            <tr><td>다수 색은 자동으로 기본값</td><td>모든 코에 색이 지정되면 <b>가장 많이 쓰인 색</b>은 본문에서 빠지고 <b>칸</b> 색으로 내려간다 —
              본문이 색 표기로 뒤덮이지 않게 하려는 것이고, 그려지는 결과는 똑같다</td></tr>
